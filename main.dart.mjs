...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredModules, loadDeferredId} = {}) {
    ...
    const dart2wasm = {
      ...
      IL: x0 => x0.localStorage,
      IM: (x0,x1) => { x0.onchange = x1 },
      ...
      LJ: (x0,x1) => { x0.src = x1 },
      LK: x0 => x0.status,
      LL: (x0,x1) => x0.transferFromImageBitmap(x1),
      LM: x0 => x0.name,
      M: o => String(o),
      ...
      QK: () => new Intl.DateTimeFormat(),
      QL: x0 => x0.width,
      QM: (x0,x1) => x0.replaceChildren(x1),
      ...
      RK: x0 => x0.resolvedOptions(),
      RL: x0 => x0.rasterEndMilliseconds,
      RM: x0 => x0.click(),
      ...
      SK: x0 => x0.timeZone,
      SL: x0 => x0.rasterStartMilliseconds,
      SM: (x0,x1,x2) => x0.setAttribute(x1,x2),
      T: x0 => new Promise(x0),
      ...
      TJ: x0 => x0.decode(),
      TK: (x0,x1,x2,x3) => x0.replaceState(x1,x2,x3),
      TL: x0 => x0.imageBitmaps,
      TM: (x0,x1) => { x0.accept = x1 },
      ...
      UK: x0 => x0.history,
      UL: x0 => x0.canvasKitMaximumSurfaces,
      UM: (x0,x1) => { x0.multiple = x1 },
      V: (constructor, args) => {
      ...
      bK: (o, t) => typeof o === t,
      bL: x0 => x0.altKey,
      bM: (x0,x1,x2,x3,x4,x5,x6,x7) => x0.unwrapKey(x1,x2,x3,x4,x5,x6,x7),
      c: o => o,
      ...
      cK: x0 => x0.data,
      cL: x0 => x0.ctrlKey,
      cM: (x0,x1,x2,x3,x4,x5) => x0.importKey(x1,x2,x3,x4,x5),
      d: (o, p) => o[p],
      dB: o => {
        if (o === null || o === undefined) return 0;
      ...
      dM: (x0,x1,x2,x3) => x0.generateKey(x1,x2,x3),
      e: () => globalThis,
      ...
      eK: (x0,x1) => x0.close(x1),
      eL: x0 => x0.code,
      eM: (x0,x1,x2,x3,x4) => x0.wrapKey(x1,x2,x3,x4),
      ...
      fK: x0 => x0.close(),
      fL: x0 => x0.repeat,
      fM: (x0,x1,x2) => x0.exportKey(x1,x2),
      ...
      gM: (x0,x1) => x0.getRandomValues(x1),
      ...
      hK: x0 => x0.readyState,
      hL: x0 => x0.userAgent,
      hM: (x0,x1,x2,x3) => x0.encrypt(x1,x2,x3),
      i: (l, r) => l === r,
      ...
      oM: (x0,x1) => new OffscreenCanvas(x0,x1),
      p: b => !!b,
      ...
      qL: (x0,x1,x2,x3) => x0.toBlob(x1,x2,x3),
      qM: x0 => x0.loader,
      r: (x0,x1) => x0.focus(x1),
      ...
      tL: (x0,x1,x2,x3) => x0.drawImage(x1,x2,x3),
      u: () => [],
      ...
      uK: x0 => x0.name,
      uL: (x0,x1,x2,x3,x4,x5) => x0.drawImage(x1,x2,x3,x4,x5),
      v: (a, i) => a.push(i),
